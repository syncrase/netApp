...
<body>
	...
	<h1>Bienvenue <bean:write name="identificationForm" property="nom"/></h1>
	<html:link action="RetourIndex">Identification</html:link>
	
	
	<html:form action="ActionTest" method="post">
